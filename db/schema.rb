...
ActiveRecord::Schema[7.2].define(version: 2025_07_04_141839) do
  ...
  create_table "buyers", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.text "address"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "couriers", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "items", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "sample_types", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  end

  create_table "team_members", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.string "phone"
    t.integer "team_id"
